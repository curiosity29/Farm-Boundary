...
class DataParser():
    def __init__(self, annotation):
        self.total_data = annotation # list of images
        self.batch_size = 3
...
#     Augmen = Augmentations()
    ...
    my_model.load_weights(r'/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/train/weights/u2net_256_capella_v2_.h5')
...
#region unused
...
#endregion    
    data_train = glob.glob('/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/data/train_data/train_data_v3/train/image/*.tif')
    data_val = glob.glob('/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/data/train_data/train_data_v3/val/image/*.tif')
    ...
    # TRAIN_LOGDIR = '/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/logs'
    TRAIN_LOGDIR = '/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/train/logs_v2'
    TRAIN_EPOCHS = 70
    best_val_loss = 100
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                print('new best val losss:', total_val/len_val)
                save_weight_path = '/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/train/weights/u2net_256_capella_v3_.h5'
                my_model.save_weights(save_weight_path)
