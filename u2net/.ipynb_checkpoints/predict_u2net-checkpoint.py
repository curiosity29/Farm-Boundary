...
if __name__=="__main__":
    model_path = r'/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/weights/u2net_256_transcript_mrsac_v1_model.h5'
    dir_img = r"/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/data/uint8_rgb"
    dir_out = r"/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/result"
    ...
    count = 0
    # my_model = Model_U2Net(256, 8)

    # my_model.load_weights
    # model_farm = tf.keras.models.load_weights(model_path)
    # model_farm = my_model.load_weights(model_path)
