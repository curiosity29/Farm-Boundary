...
#     Augmen = Augmentations()
    ...
    my_model.load_weights(r'/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/weights/u2net_256_edge_buff_add_aug_model_v27.h5')
    ...
    data_train = glob.glob('/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/train_data/train/image/*.tif')
    data_val = glob.glob('/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/train_data/val/image/*.tif')
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                my_model.save_weights(os.path.join("/home/skymap/big_data/Dao_work_space/MRSAC/Bang_diem/weights/u2net_256_transcript_mrsac_v2.h5"))
