                        ...
                        # print(y_pred.shape)
                            with write_lock:
                                for i in range(len(coordinates)):
                                    ...
                                    y_pred0 = y_pred[i]
                                    # y_pred0 = (y_pred0[0,...,0] > 0.2).astype(np.uint8)
                                    y_pred0 = (y_pred0[0,...,0] ).astype(np.uint8)
...
def raster_to_vector(path_in, path_out, threshold_distance, threshold_connect):
    ...
    data = remove_small_objects(data, min_size=20)
...
if __name__=="__main__":
    ...
    # img_path = r'/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/data/3bands_16bits_usecode_8bit_perimage_2970255/3bands_16bits_usecode/CAPELLA_C02_SP_GEO_HH_20210318155305_20210318155327.tif'
    # output_path = r'/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/data/test/results//CAPELLA_C02_SP_GEO_HH_20210318155305_20210318155327_ressult3.geojson'

    import glob
    model_path = r'/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/code/code_aDuy/farm_predict/model_farm.h5'
    for img_path in glob.glob('/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/code/code_aDuy/image/'+'*.tif'):
        if os.path.basename(img_path) != "Karnataka_6.tif" or "Karnataka_7.tif": continue
        out_path = '/home/skymap/big_data/Giang_workspace/Task_110123_Farm_boundary_Edge_Detect/code/code_aDuy/image/result'+os.path.basename(img_path)
        ...
        # model = Model_U2Net(512, 3)

        # model.load_weights(model_path)
        model = tf.keras.models.load_model(model_path)
        # model.trainable = False
        cache_path = out_path.replace('.geojson', '.tif')
        print("Start predict image:", args.input_path)
